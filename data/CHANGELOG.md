...
Generated 2026-09-25T14:49:21.617Z from the live V11 and V12 Storybooks. Values are computed styles.

Components: 30 unchanged · 30 changed · 18 new · 20 inherited · 4 removed
...
- **Visual** Breadcrumb · .cds--tooltip-trigger__wrapper · line-height 0px → 18.0001px (inherited from Tooltip) _(2 stories)_
- **Visual** Breadcrumb · .cds--popover · line-height 0px → 18.0001px (inherited from Popover) _(2 stories)_
- **Visual** Breadcrumb · .cds--autoalign.cds--icon-tooltip.cds--popover-container.cds--tooltip · line-height 0px → 18.0001px (inherited from IconButton, Popover, Tooltip) _(2 stories)_
...
- **Visual** Breadcrumb · .cds--autoalign.cds--icon-tooltip.cds--popover-container.cds--tooltip · line-height 0px → 16px (inherited from IconButton, Popover, Tooltip)
...
- **Structure** Breadcrumb · .cds--autoalign.cds--menu.cds--menu--border.cds--menu--md.cds--menu--open.cds--menu--shown.cds--overflow-menu__bottom-start element added (inherited from OverflowMenu)
...
- **Visual** ComboButton · .cds--btn · display inline-flex → block (inherited from Button)
- **Visual** ComboButton · .cds--btn · padding 0px → 14px 63px 14px 15px (inherited from Button)
- **Layout** ComboButton · .cds--btn · width 48px → 172.25px (+124.25px) (inherited from Button)
...
- **Structure** ComboButton · .cds--autoalign.cds--icon-tooltip.cds--popover--auto-align.cds--popover--high-contrast.cds--popover--top.cds--popover-container.cds--tooltip element added (inherited from Tooltip)
...
- **Structure** ComboButton · .cds--autoalign.cds--icon-tooltip.cds--popover--auto-align.cds--popover--high-contrast.cds--popover--top.cds--popover-container.cds--tooltip element removed (inherited from Tooltip)
...
- **Visual** ContainedList · .cds--autoalign.cds--icon-tooltip.cds--popover-container.cds--tooltip · line-height 0px → 16px (inherited from IconButton, Popover, Tooltip)
...
- **Visual** DatePicker · .cds--label · border-radius 0px → 4px (inherited from FormLabel)
...
- **Visual** Fluid Components · .cds--autoalign.cds--combo-box.cds--list-box · background-color #f4f4f4 → transparent (inherited from ComboBox, Dropdown) _(4 stories)_
...
- **Visual** Fluid Components · .cds--autoalign.cds--list-box.cds--multi-select · background-color #f4f4f4 → transparent (inherited from Dropdown, MultiSelect) _(4 stories)_
...
- **Visual** Fluid Components · .cds--autoalign.cds--combo-box.cds--list-box · border-radius 0px → 4px (inherited from ComboBox, Dropdown) _(4 stories)_
...
- **Visual** Fluid Components · .cds--select-input__wrapper · border-radius 0px → 4px (inherited from Select) _(4 stories)_
- **Visual** Fluid Components · .cds--select-input · border-radius 0px → 4px (inherited from Select) _(4 stories)_
- **Visual** Fluid Components · .cds--autoalign.cds--list-box.cds--multi-select · border-radius 0px → 4px (inherited from Dropdown, MultiSelect) _(4 stories)_
- **Visual** Fluid Components · .cds--autoalign.cds--combo-box.cds--list-box · border-top/right/left none → 1px solid transparent (inherited from ComboBox, Dropdown) _(4 stories)_
...
- **Visual** Fluid Components · .cds--autoalign.cds--list-box.cds--multi-select · border-top/right/left none → 1px solid transparent (inherited from Dropdown, MultiSelect) _(4 stories)_
- **Visual** Fluid Components · .cds--form-item · border-top/right/left none → 1px solid transparent _(4 stories)_
- **Visual** Fluid Components · .cds--combo-box.cds--list-box.cds--multi-select · background-color #f4f4f4 → transparent (inherited from ComboBox, Dropdown, MultiSelect) _(3 stories)_
- **Visual** Fluid Components · .cds--autoalign.cds--combo-box.cds--list-box · background-image none → linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#e0e0e0 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from ComboBox, Dropdown) _(3 stories)_
...
- **Visual** Fluid Components · .cds--combo-box.cds--list-box.cds--multi-select · background-image none → linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#e0e0e0 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from ComboBox, Dropdown, MultiSelect) _(3 stories)_
- **Visual** Fluid Components · .cds--autoalign.cds--list-box.cds--multi-select · background-image none → linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#e0e0e0 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from Dropdown, MultiSelect) _(3 stories)_
- **Visual** Fluid Components · .cds--text-input · border-bottom 1px solid #8d8d8d → none _(3 stories)_
- **Visual** Fluid Components · .cds--autoalign.cds--combo-box.cds--list-box · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from ComboBox, Dropdown) _(3 stories)_
...
- **Visual** Fluid Components · .cds--combo-box.cds--list-box.cds--multi-select · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from ComboBox, Dropdown, MultiSelect) _(3 stories)_
- **Visual** Fluid Components · .cds--autoalign.cds--list-box.cds--multi-select · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from Dropdown, MultiSelect) _(3 stories)_
...
- **Visual** Fluid Components · .cds--combo-box.cds--list-box.cds--multi-select · border-radius 0px → 4px (inherited from ComboBox, Dropdown, MultiSelect) _(3 stories)_
...
- **Visual** Fluid Components · .cds--combo-box.cds--list-box.cds--multi-select · border-top/right/left none → 1px solid transparent (inherited from ComboBox, Dropdown, MultiSelect) _(3 stories)_
- **Visual** Fluid Components · .cds--search-input · background-color #f4f4f4 → transparent (inherited from Search) _(2 stories)_
- **Visual** Fluid Components · .cds--form-item.cds--password-input-wrapper.cds--text-input-wrapper · background-color #f4f4f4 → transparent (inherited from PasswordInput, TextInput) _(2 stories)_
- **Visual** Fluid Components · .cds--password-input.cds--text-input · background-color #f4f4f4 → transparent (inherited from PasswordInput, TextInput) _(2 stories)_
...
- **Visual** Fluid Components · .cds--password-input.cds--text-input · background-image none → linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#e0e0e0 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from PasswordInput, TextInput) _(2 stories)_
...
- **Visual** Fluid Components · .cds--password-input.cds--text-input · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from PasswordInput, TextInput) _(2 stories)_
- **Visual** Fluid Components · .cds--date-picker__input.cds--date-picker__input--md · border-left 1px solid #8d8d8d → 1px solid #e0e0e0 (inherited from DatePicker) _(2 stories)_
...
- **Visual** Fluid Components · .cds--password-input.cds--text-input · border-radius 0px → 4px (inherited from PasswordInput, TextInput) _(2 stories)_
- **Visual** Fluid Components · .cds--btn.cds--tooltip__trigger · border-radius 0px → 4px (inherited from Tooltip) _(2 stories)_
...
- **Visual** Fluid Components · .cds--password-input.cds--text-input · border-top/right/left none → 1px solid transparent (inherited from PasswordInput, TextInput) _(2 stories)_
- **Visual** Fluid Components · .cds--number__rule-divider · display block → none (inherited from NumberInput) _(2 stories)_
- **Visual** Fluid Components · .cds--combo-box.cds--list-box.cds--multi-select · background-color #ffffff → transparent (inherited from ComboBox, Dropdown, MultiSelect)
- **Visual** Fluid Components · .cds--autoalign.cds--combo-box.cds--list-box · background-image linear-gradient(0deg, #4589ff / 16% 0%, 15%, transparent 50%, transparent 100%) → linear-gradient(0deg, #4589ff / 16% 0%, 15%, transparent 50%, transparent 100%), linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#a6c8ff / 64% calc(100% - 4px), #4589ff 100%) (inherited from ComboBox, Dropdown)
...
- **Visual** Fluid Components · .cds--combo-box.cds--list-box.cds--multi-select · background-image none → linear-gradient(#ffffff, #ffffff), linear-gradient(#c6c6c6 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from ComboBox, Dropdown, MultiSelect)
- **Visual** Fluid Components · .cds--autoalign.cds--list-box.cds--multi-select · background-image linear-gradient(0deg, #4589ff / 16% 0%, 15%, transparent 50%, transparent 100%) → linear-gradient(0deg, #4589ff / 16% 0%, 15%, transparent 50%, transparent 100%), linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#a6c8ff / 64% calc(100% - 4px), #4589ff 100%) (inherited from Dropdown, MultiSelect)
...
- **Layout** Fluid Components · .cds--form-item · width 411px → 415px (+4px) (inherited from preview__Layout)
...
- **Visual** Form · .cds--combo-box.cds--list-box.cds--multi-select · background-color #f4f4f4 → transparent (inherited from ComboBox, Dropdown, MultiSelect) _(2 stories)_
- **Visual** Form · .cds--password-input.cds--text-input · background-color #f4f4f4 → transparent (inherited from PasswordInput, TextInput) _(2 stories)_
- **Visual** Form · .cds--autoalign.cds--combo-box.cds--list-box · background-color #f4f4f4 → transparent (inherited from ComboBox, Dropdown) _(2 stories)_
- **Visual** Form · .cds--autoalign.cds--list-box.cds--multi-select · background-color #f4f4f4 → transparent (inherited from Dropdown, MultiSelect) _(2 stories)_
...
- **Visual** Form · .cds--password-input.cds--text-input · background-image none → linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#e0e0e0 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from PasswordInput, TextInput) _(2 stories)_
...
- **Visual** Form · .cds--password-input.cds--text-input · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from PasswordInput, TextInput) _(2 stories)_
...
- **Visual** Form · .cds--combo-box.cds--list-box.cds--multi-select · border-radius 0px → 4px (inherited from ComboBox, Dropdown, MultiSelect) _(2 stories)_
- **Visual** Form · .cds--password-input.cds--text-input · border-radius 0px → 4px (inherited from PasswordInput, TextInput) _(2 stories)_
- **Visual** Form · .cds--btn · border-radius 0px → 999999px (pill) (inherited from Button) _(2 stories)_
- **Visual** Form · .cds--btn.cds--tooltip__trigger · border-radius 0px → 4px (inherited from Tooltip) _(2 stories)_
- **Visual** Form · .cds--autoalign.cds--combo-box.cds--list-box · border-radius 0px → 4px (inherited from ComboBox, Dropdown) _(2 stories)_
- **Visual** Form · .cds--autoalign.cds--list-box.cds--multi-select · border-radius 0px → 4px (inherited from Dropdown, MultiSelect) _(2 stories)_
...
- **Visual** Form · .cds--combo-box.cds--list-box.cds--multi-select · border-top/right/left none → 1px solid transparent (inherited from ComboBox, Dropdown, MultiSelect) _(2 stories)_
- **Visual** Form · .cds--password-input.cds--text-input · border-top/right/left none → 1px solid transparent (inherited from PasswordInput, TextInput) _(2 stories)_
- **Visual** Form · .cds--autoalign.cds--combo-box.cds--list-box · border-top/right/left none → 1px solid transparent (inherited from ComboBox, Dropdown) _(2 stories)_
- **Visual** Form · .cds--autoalign.cds--list-box.cds--multi-select · border-top/right/left none → 1px solid transparent (inherited from Dropdown, MultiSelect) _(2 stories)_
...
- **Visual** Form · .cds--combo-box.cds--list-box.cds--multi-select · background-image none → linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#e0e0e0 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from ComboBox, Dropdown, MultiSelect)
- **Visual** Form · .cds--autoalign.cds--combo-box.cds--list-box · background-image none → linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#e0e0e0 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from ComboBox, Dropdown)
- **Visual** Form · .cds--autoalign.cds--list-box.cds--multi-select · background-image none → linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#e0e0e0 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from Dropdown, MultiSelect)
...
- **Visual** Form · .cds--combo-box.cds--list-box.cds--multi-select · background-image linear-gradient(0deg, #4589ff / 16% 0%, 15%, transparent 50%, transparent 100%) → linear-gradient(0deg, #4589ff / 16% 0%, 15%, transparent 50%, transparent 100%), linear-gradient(#f4f4f4, #f4f4f4), linear-gradient(#a6c8ff / 64% calc(100% - 4px), #4589ff 100%) (inherited from ComboBox, Dropdown, MultiSelect)
...
- **Visual** Form · .cds--combo-box.cds--list-box.cds--multi-select · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from ComboBox, Dropdown, MultiSelect)
- **Visual** Form · .cds--text-input · border-bottom 1px solid #8d8d8d → none
- **Visual** Form · .cds--autoalign.cds--combo-box.cds--list-box · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from ComboBox, Dropdown)
- **Visual** Form · .cds--autoalign.cds--list-box.cds--multi-select · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from Dropdown, MultiSelect)
...
- **Visual** Modal · .cds--autoalign.cds--combo-box.cds--list-box · background-color #ffffff → transparent (inherited from ComboBox, Dropdown) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--list-box.cds--multi-select · background-color #ffffff → transparent (inherited from Dropdown, MultiSelect) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--combo-box.cds--list-box · background-image none → linear-gradient(#ffffff, #ffffff), linear-gradient(#c6c6c6 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from ComboBox, Dropdown) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--list-box.cds--multi-select · background-image none → linear-gradient(#ffffff, #ffffff), linear-gradient(#c6c6c6 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from Dropdown, MultiSelect) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--combo-box.cds--list-box · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from ComboBox, Dropdown) _(2 stories)_
- **Visual** Modal · .cds--text-input · border-bottom 1px solid #8d8d8d → none _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--list-box.cds--multi-select · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from Dropdown, MultiSelect) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--combo-box.cds--list-box · border-radius 0px → 4px (inherited from ComboBox, Dropdown) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--list-box.cds--multi-select · border-radius 0px → 4px (inherited from Dropdown, MultiSelect) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--combo-box.cds--list-box · border-top/right/left none → 1px solid transparent (inherited from ComboBox, Dropdown) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--list-box.cds--multi-select · border-top/right/left none → 1px solid transparent (inherited from Dropdown, MultiSelect) _(2 stories)_
- **Visual** Modal · .cds--autoalign.cds--dropdown.cds--list-box · background-color #ffffff → transparent (inherited from Dropdown)
- **Visual** Modal · .cds--autoalign.cds--dropdown.cds--list-box · background-image none → linear-gradient(#ffffff, #ffffff), linear-gradient(#c6c6c6 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from Dropdown)
...
- **Visual** Modal · .cds--popover-content.cds--tooltip-content · border-radius 2px → 4px (inherited from Tooltip)
...
- **Visual** OverflowMenu · .cds--autoalign.cds--icon-tooltip.cds--popover-container.cds--tooltip · line-height 0px → 16px (inherited from IconButton, Popover, Tooltip)
...
- **Structure** OverflowMenu · .cds--autoalign.cds--icon-tooltip.cds--popover--auto-align.cds--popover--high-contrast.cds--popover--top.cds--popover-container.cds--tooltip element added (inherited from Tooltip)
...
- **Structure** OverflowMenu · .cds--icon-tooltip.cds--popover--caret.cds--popover--high-contrast.cds--popover--top.cds--popover-container.cds--tooltip element removed (inherited from Tooltip)
...
- **Visual** PasswordInput · .cds--btn.cds--tooltip__trigger · border-radius 0px → 4px (inherited from Tooltip)
...
- **Visual** ComposedModal · .cds--popover-content.cds--tooltip-content · border-radius 2px → 4px (inherited from Tooltip) _(2 stories)_
- **Visual** ComposedModal · .cds--dropdown.cds--list-box · background-color #ffffff → transparent (inherited from Dropdown)
- **Visual** ComposedModal · .cds--autoalign.cds--list-box.cds--multi-select · background-color #ffffff → transparent (inherited from Dropdown, MultiSelect)
...
- **Visual** ComposedModal · .cds--autoalign.cds--list-box.cds--multi-select · background-image none → linear-gradient(#ffffff, #ffffff), linear-gradient(#c6c6c6 calc(100% - 4px), #8d8d8d 100%) (now drawn with gradients) (inherited from Dropdown, MultiSelect)
...
- **Visual** ComposedModal · .cds--autoalign.cds--list-box.cds--multi-select · border-bottom 1px solid #8d8d8d → 1px solid transparent (inherited from Dropdown, MultiSelect)
- **Visual** ComposedModal · .cds--dropdown.cds--list-box · border-radius 0px → 4px (inherited from Dropdown)
- **Visual** ComposedModal · .cds--autoalign.cds--list-box.cds--multi-select · border-radius 0px → 4px (inherited from Dropdown, MultiSelect)
- **Visual** ComposedModal · .cds--dropdown.cds--list-box · border-top/right/left none → 1px solid transparent (inherited from Dropdown)
- **Visual** ComposedModal · .cds--autoalign.cds--list-box.cds--multi-select · border-top/right/left none → 1px solid transparent (inherited from Dropdown, MultiSelect)
...
- **Visual** DataTable · .cds--autoalign.cds--icon-tooltip.cds--popover-container.cds--tooltip · display inline-block → block (inherited from IconButton, Popover, Tooltip) _(8 stories)_
...
- **Visual** DataTable · .cds--autoalign.cds--icon-tooltip.cds--popover-container.cds--tooltip · line-height 0px → 16px (inherited from IconButton, Popover, Tooltip) _(8 stories)_
- **Visual** DataTable · .cds--btn.cds--overflow-menu · padding 8px 0px → 0px (inherited from Button, OverflowMenu) _(8 stories)_
...
- **Visual** DataTable · .cds--btn.cds--overflow-menu · border-radius 0px → 999999px (pill) (inherited from Button, OverflowMenu)
- **Visual** DataTable · .cds--tooltip-trigger__wrapper · line-height 0px → 18.0001px (inherited from Tooltip)
- **Visual** DataTable · .cds--popover · line-height 0px → 18.0001px (inherited from Popover)
- **Visual** DataTable · .cds--autoalign.cds--icon-tooltip.cds--popover-container.cds--tooltip · line-height 0px → 18.0001px (inherited from IconButton, Popover, Tooltip)
...
- **Visual** IconButton · .cds--popover-content.cds--tooltip-content · border-radius 2px → 4px (inherited from Tooltip)
...
- **Visual** Pagination · .cds--popover-content.cds--tooltip-content · border-radius 2px → 4px (inherited from Tooltip)
...
- **Visual** Tabs · .cds--popover-content.cds--tooltip-content · border-radius 2px → 4px (inherited from Tooltip) _(2 stories)_
...
- **Visual** preview__Dialog · .cds--popover-content.cds--tooltip-content · border-radius 2px → 4px (inherited from Tooltip) _(3 stories)_
...
- **Visual** preview__OverflowMenuV2 · .cds--btn.cds--overflow-menu · border-radius 0px → 999999px (pill) (inherited from Button, OverflowMenu)
...
- **Story** ConditionBuilder · story added: Default
- **Story** ConditionBuilder · story added: Controlled Hierarchical
- **Story** ConditionBuilder · story added: Hierarchical
- **Story** ConditionBuilder · story added: Hierarchical With Actions
- **Story** ConditionBuilder · story added: Hierarchical With Initial State
- **Story** ConditionBuilder · story added: With Actions
- **Story** ConditionBuilder · story added: With Custom Operators
- **Story** ConditionBuilder · story added: With Custom Statements
- **Story** ConditionBuilder · story added: With Disabled Properties
- **Story** ConditionBuilder · story added: With Dynamic Options
- **Story** ConditionBuilder · story added: With Initial State
